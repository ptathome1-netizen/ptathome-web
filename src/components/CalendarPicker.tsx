    ...
    <section className="rounded-2xl border border-[#E6E0D6] bg-white/80 p-5 shadow-sm">
      ...
      <div className="relative overflow-x-auto">
        <table className="w-full border-separate border-spacing-0">
          <thead>
            <tr>
              <th className="sticky left-0 z-10 bg-white/90 px-2 py-2 text-left backdrop-blur">
                <Text
                  as="span"
                  variant="caption"
                  tone="slateMuted"
          ...
          <tbody>
            {HOUR_LIST.map((hh) => (
              <tr key={hh}>
                <td className="sticky left-0 z-10 bg-white/90 px-2 py-1 backdrop-blur">
                  <Text
                    as="span"
                    variant="caption"
                    tone="slateMuted"
      ...
      <div className="mt-4 rounded-xl bg-[#FAF8F3] px-3 py-2">
        <Text as="span" variant="bodySm" tone="slate" className="text-sm text-[#374151]">
