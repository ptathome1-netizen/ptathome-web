// src/components/VisitProcessSection.tsx
"use client";
    ...
    <section className="w-full bg-[#F9F4EF] py-20">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-4 md:px-6 lg:px-8">
        ...
        <div className="max-w-3xl space-y-3">
          ...
          <p className="whitespace-pre-line text-sm leading-relaxed text-[#5E5147] sm:text-[0.95rem]">
            {COPY.description}
          </p>
        </div>
